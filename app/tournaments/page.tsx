  ...
  return (
    <main className="mx-auto max-w-4xl p-6">
      ...
      {tournaments.length === 0 ? (
        <p className="mb-8 text-text-secondary">No tournaments yet.</p>
      ) : (
          ...
          {tournaments.map((t) => {
            ...
            return (
              <a
                ...
                className="block rounded border border-border p-4 hover:border-primary hover:bg-surface-hover/40 transition-colors"
              >
